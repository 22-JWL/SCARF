...
출력:
{
  "action": "openWindow", "windowName": "","response": "어떤 티칭창을 열까요? 티칭창 목록 제시."
}
...
출력:
{
  "action": "openWindow", "windowName": "", "response": "어떤 창을 열까요? 열 수 있는 창 목록 제시."
}
...
출력:
{
  "action": "openWindow", "windowName": "", "response": "어떤 창을 열까요? sfafvadv 창은 존재하지 않습니다."}
}
